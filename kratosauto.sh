...
echo -e "  𝚄𝙿𝙳𝙰𝚃𝙴𝙸𝙽𝙶 𝙿𝙻𝙴𝙰𝚂𝙴 𝚆𝙰𝙸𝚃•••• " 
sleep 0.45
rm -rf kratosexcelent &> /dev/null && cd /data/data/com.termux/files/usr/bin &> /dev/null && rm -rf main.sh pubggl.sh pubgkr.sh &> /dev/null &&  git clone https://github.com/soumenh/kratosexcelent &> /dev/null && cp -r kratosexcelent/main.sh /data/data/com.termux/files/usr/bin &> /dev/null && cp -r kratosexcelent/pubggl.sh /data/data/com.termux/files/usr/bin &> /dev/null && cp -r kratosexcelent/pubgkr.sh /data/data/com.termux/files/usr/bin &> /dev/null && chmod 777 /data/data/com.termux/files/usr/bin/main.sh &> /dev/null &&  chmod 777 /data/data/com.termux/files/usr/bin/pubggl.sh &> /dev/null  &&  chmod 777 /data/data/com.termux/files/usr/bin/pubgkr.sh &> /dev/null && rm -rf kratosexcelent &> /dev/null  
echo " "
echo " "
echo " "
echo " "
