...
rm -rf kratosexcelent &> /dev/null && cd /data/data/com.termux/files/usr/bin &> /dev/null && rm -rf main.sh pubggl.sh pubgkr.sh &> /dev/null &&  git clone https://github.com/soumenh/kratosexcelent &> /dev/null && cp -r kratosexcelent/main.sh /data/data/com.termux/files/usr/bin &> /dev/null && cp -r kratosexcelent/pubggl.sh /data/data/com.termux/files/usr/bin &> /dev/null && cp -r kratosexcelent/pubgkr.sh /data/data/com.termux/files/usr/bin &> /dev/null && chmod 777 /data/data/com.termux/files/usr/bin/main.sh &> /dev/null &&  chmod 777 /data/data/com.termux/files/usr/bin/pubggl.sh &> /dev/null  &&  chmod +x /data/data/com.termux/files/usr/bin/pubgkr.sh &> /dev/null && cp -r kratosexcelent/kratos1.sh /sdcard/KRATOSEXCELENT &> /dev/null && cp -r kratosexcelent/kratos2.sh /sdcard/KRATOSEXCELENT &> /dev/null && cp -r kratosexcelent/kratos3.sh /sdcard/KRATOSEXCELENT &> /dev/null &&  rm -rf kratosexcelent &> /dev/null   
echo " "
echo " "
echo " "
echo " "
